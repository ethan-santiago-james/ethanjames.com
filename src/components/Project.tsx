    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://lecture-cram-planner-v2-0.onrender.com" target="_blank" rel="noreferrer"><img src={lcp} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://lecture-cram-planner-v2-0.onrender.com" target="_blank" rel="noreferrer"><h2>Lecture Cram Planner</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/ethan-santiago-james/Internship-Web-Scraper/tree/master" target="_blank" rel="noreferrer"><img src={scraper} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/ethan-santiago-james/Internship-Web-Scraper/tree/master" target="_blank" rel="noreferrer"><h2>Internship Web Scraper</h2></a>
                <p>Developed a Python application that can scrape the web for opportunities from various companies.</p>
            </div>
            <div className="project">
                <a href="https://github.com/ethan-santiago-james/Athletics-Race-Simulator" target="_blank" rel="noreferrer"><img src={athletics} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/ethan-santiago-james/Athletics-Race-Simulator" target="_blank" rel="noreferrer"><h2>Athletics Race Simulator</h2></a>
            ...
            <div className="project">
                <a href="https://play.unity.com/en/games/3577653b-22cf-42e0-b658-ae589bb4f53f/zombie-horror-game" target="_blank" rel="noreferrer"><img src={horrorgame} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://play.unity.com/en/games/3577653b-22cf-42e0-b658-ae589bb4f53f/zombie-horror-game" target="_blank" rel="noreferrer"><h2>Zombie Horror Game</h2></a>
            ...
            <div className="project">
                <a href="https://github.com/ethan-santiago-james/ML-Practice" target="_blank" rel="noreferrer"><img src={ML} className="zoom" alt="thumbnail" width="100%"/></a>
                <a href="https://github.com/ethan-santiago-james/ML-Practice" target="_blank" rel="noreferrer"><h2>Machine Learning Practice</h2></a>
